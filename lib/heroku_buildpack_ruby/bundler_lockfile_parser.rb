module HerokuBuildpackRuby
  ...
  # Example:
  #
  #   dependencies = BundlerLockfileParser.new(gemfile_lock_path: "./Gemfile.lock", bundler_install_path: bundler_install_path).call
  #   dependencies.has_gem?("rails") # => true
  #   dependencies.version("rails") # => Gem::Version.new("6.0.0")
  class BundlerLockfileParser
    private; attr_reader :parser, :gemfile_lock_path, :bundler_install_path; public

    def initialize(gemfile_lock_path: , bundler_install_path: )
      @bundler_install_path = Pathname.new(bundler_install_path)
