  ...
  it "can read dependencies" do
    isolate_in_fork do
      Dir.mktmpdir do |dir|
        ...
        bundler_install_path = dir.join("bundler").tap(&:mkpath)
        HerokuBuildpackRuby::BundlerDownload.new(
          version: "2.1.4",
          install_dir: bundler_install_path
        ).call
        ...
        expect(dependencies.bundler_lib_path.to_s).to eq(bundler_install_path.join("gems/bundler-2.1.4/lib").to_s)
